...
func _ready():
	...
	$ControlsListL/Alter.load_button("Alter", Settings.button_to_string(input_map.P1_alter))
...
func load_player_input():
	...
	$ControlsListL/Alter.map(Settings.button_to_string(input_map["P" + player_index + "_alter"]))
