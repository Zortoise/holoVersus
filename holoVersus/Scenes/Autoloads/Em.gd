...
enum atk_attr {ASSIST, NO_CHAIN, ANTI_AIR, AUTOCHAIN, FOLLOW_UP, LEDGE_DROP, NO_TURN, NO_QUICK_CANCEL
		...
		CHIPPER, LAST_HIT_WAVE, REPEL_ON_BLOCK, CROSSUP_PROTECTION, SS_LAUNCH, NO_HITSTUN}
...
# PUNISH_ENTITY = entity can land punish hit without being Proj Level 2, used for projectiles with special effects on landing punish hits
...
# NO_HITSTUN = for certain projectiles, act as if target armored it
...
enum hit {RECT, POLYGON, OWNER_ID, FACING, MOVE_NAME, MOVE_DATA, MOB, HURTBOX, SDHURTBOX, HITBOX, SWEETBOX, KBORIGIN, VACPOINT
		...
		DEFENDER_MOVE_DATA, DEFENDER_ATTR, NPC_DEFENDER_PATH, PROJ_ON_HITSTOP, CROSSED_UP, DASHED_THROUGH_PROJ}
#// RES_DRAIN, CORNERED

enum entity_trait {GROUNDED, AIR_GROUND, LEDGE_STOP, BLAST_BARRIER_COLLIDE, PERMANENT, BEAM, NO_BOUNCE, FLOATY_ITEM, SPAWN_OFFSET}
# AIR_GROUND = ground projectile that falls if not grounded
...
enum button {P1_UP, P1_DOWN, P1_LEFT, P1_RIGHT, P1_JUMP, P1_LIGHT, P1_FIERCE, P1_DASH, P1_BLOCK, P1_AUX, P1_ALTER, 
		P1_UNIQUE, P1_PAUSE, P1_RS_LEFT, P1_RS_RIGHT, P1_RS_UP, P1_RS_DOWN
		P2_UP, P2_DOWN, P2_LEFT, P2_RIGHT, P2_JUMP, P2_LIGHT, P2_FIERCE, P2_DASH, P2_BLOCK, P2_AUX, P2_ALTER, P2_UNIQUE,
