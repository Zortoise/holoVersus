...
var burst_counter_move_data = {
		"starting_anim" : "Kill",
		"starting_velocity" : 0,
		"starting_rot" : 0,
		"grounded" : false,
		"palette" : "yellow",
#		"collision_box_size" : Vector2.ZERO,
		
		"move_name" : "BurstCounter", # for entities, keep move_name in move_data, for checking repeat_penalty
		"atk_type" : Globals.atk_type.PROJECTILE,
		"hitcount" : 1,
		"damage" : 0,
		"knockback" : 550,
		...
		"KB_angle" : 0.0,
#		"atk_attr" : [Globals.atk_attr.EASY_BLOCK], # atk_attr of Burst in Character.gd's query_atk_attr()
#		"spawn_sound" : { ref = "blast1", aux_data = {"vol" : -18,} },
		"hit_sound" : { ref = "blast2", aux_data = {"vol" : -9} },
#		"kill_sound" : {}
	}
	
var burst_escape_move_data = {
		"starting_anim" : "Kill",
		"starting_velocity" : 0,
		"starting_rot" : 0,
		"grounded" : false,
...
#		"collision_box_size" : Vector2.ZERO,
		...
		"KB_angle" : 0.0,
#		"atk_attr" : [Globals.atk_attr.EASY_BLOCK],
#		"spawn_sound" : { ref = "blast1", aux_data = {"vol" : -18,} },
		"hit_sound" : { ref = "blast2", aux_data = {"vol" : -9} },
#		"kill_sound" : {}
	}
	
var burst_extend_move_data = {
		"starting_anim" : "Kill",
		"starting_velocity" : 0,
		"starting_rot" : 0,
		"grounded" : false,
