...
func _ready():
	...
	$ControlsListR/Assist.load_button("Assist", Settings.button_to_string(input_map.P1_assist))
	$ControlsListR/Special.load_button("Special", Settings.button_to_string(input_map.P1_special))
	$ControlsListR/EX.load_button("EX", Settings.button_to_string(input_map.P1_EX))
...
func load_player_input():
	...
	$ControlsListR/Assist.map(Settings.button_to_string(input_map["P" + player_index + "_assist"]))
	$ControlsListR/Special.map(Settings.button_to_string(input_map["P" + player_index + "_special"]))
	$ControlsListR/EX.map(Settings.button_to_string(input_map["P" + player_index + "_EX"]))
