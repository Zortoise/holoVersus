...
const DEFAULT_PRESETS = {
		...
		"Gamepad D1" : {
			...
			"rs_down" : [0, JOY_ANALOG_RY, 1.0],
			"rs_left" : [0, JOY_ANALOG_RX, -1.0],
			"rs_right" : [0, JOY_ANALOG_RX, 1.0],
			"tapjump" : 0,
			"dj_fastfall" : 0,
			"buffer" : 5,
			"input_assist" : 1,
		...
		"Gamepad D2" : {
			...
			"rs_down" : [1, JOY_ANALOG_RY, 1.0],
			"rs_left" : [1, JOY_ANALOG_RX, -1.0],
			"rs_right" : [1, JOY_ANALOG_RX, 1.0],
			"tapjump" : 0,
			"dj_fastfall" : 0,
			"buffer" : 5,
			"input_assist" : 1,
...
func load_last_picked():
	...
	var valid := true 			
	for check in ["P1_character", "P1_palette", "P1_stage", "P1_assist", \
			"P2_character", "P2_palette", "P2_stage", "P2_assist"]:
