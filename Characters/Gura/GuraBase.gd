...
const MOVE_DATABASE = {
	...
	"F2" : {
		...
		Em.move.KB_ANGLE : 0,
		Em.move.ATK_ATTR : [Em.atk_attr.LATE_CHAIN],
	...
	"F2[h]" : {
		...
		Em.move.KB_ANGLE : 0,
		Em.move.ATK_ATTR : [Em.atk_attr.NO_REPEAT_MOVE, Em.atk_attr.NO_CHAIN],
		Em.move.MOVE_SOUND : { ref = "whoosh1", aux_data = {"vol" : -12,} },
		Em.move.HIT_SOUND : { ref = "cut2", aux_data = {"vol" : -15} },
	},
	"F3" : {
	...
	"H" : {
		...
		Em.move.ATK_LVL : 6,
		Em.move.KB_ANGLE : -75,
		Em.move.ATK_ATTR : [Em.atk_attr.AUTOCHAIN, Em.atk_attr.NO_CHAIN, Em.atk_attr.NO_REPEAT_MOVE],
	...
	"Hb" : {
		...
		Em.move.ATK_LVL : 6,
		Em.move.KB_ANGLE : -75,
		Em.move.ATK_ATTR : [Em.atk_attr.FOLLOW_UP, Em.atk_attr.NO_IMPULSE, Em.atk_attr.DESTROY_ENTITIES, Em.atk_attr.NO_REPEAT_MOVE],
	...
	"aF2" : {
		...
		Em.move.FIXED_SS_HITSTOP : 12,
		Em.move.KB_ANGLE : 70,
		Em.move.ATK_ATTR : [Em.atk_attr.NO_REPEAT_MOVE, Em.atk_attr.NO_SS_ATK_LVL_BOOST],
	...
	"aH" : {
		...
		Em.move.ATK_LVL : 5,
		Em.move.KB_ANGLE : 45,
		Em.move.ATK_ATTR : [Em.atk_attr.DESTROY_ENTITIES, Em.atk_attr.CRUSH],
...
#		"quick_turn_limit" : 4, # if on ground, can only quick turn on the first X frames
		...
		Em.move.KB_ANGLE : -20,
#		"reset_type" : Globals.reset_type.STARTUP_RESET,
		Em.move.ATK_ATTR : [Em.atk_attr.AUTOCHAIN, Em.atk_attr.DESTROY_ENTITIES],
		Em.move.MOVE_SOUND : [{ ref = "launch2", aux_data = {"vol" : -5,} }, { ref = "impact33", aux_data = {"vol" : -23,} }],
		Em.move.HIT_SOUND : { ref = "cut5", aux_data = {"vol" : -7} },
	},
	"aSP5[h]b" : {
...
#		"quick_turn_limit" : 4, # if on ground, can only quick turn on the first X frames
		...
		Em.move.HITSPARK_PALETTE : "red",
		Em.move.KB_ANGLE : -45,
		Em.move.ATK_ATTR : [Em.atk_attr.FOLLOW_UP, Em.atk_attr.DESTROY_ENTITIES, Em.atk_attr.NO_IMPULSE],
		Em.move.MOVE_SOUND : [{ ref = "launch2", aux_data = {"vol" : -5,} }, { ref = "impact33", aux_data = {"vol" : -23,} }],
		Em.move.HIT_SOUND : { ref = "cut5", aux_data = {"vol" : -7} },
	},
	"aSP5[ex]" : {
